...
const ASSETS = [
  ...
  BASE + 'nightmare-bonnie-blast.html',
  BASE + 'nightmare-shooter.html',
  BASE + 'puppet-box.html',
  BASE + 'puppet-chase-fp.html',
  BASE + 'puppet-chase.html',
  BASE + 'puppet-shooter.html',
  BASE + 'turret-battle.html',
  BASE + 'turret-block-blast.html',
  BASE + 'five-nights-peppys.html',
  BASE + 'manifest.json',
  BASE + 'icon-192.png',
  BASE + 'icon-512.png',
];
